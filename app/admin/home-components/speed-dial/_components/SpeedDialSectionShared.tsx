...
const renderDock = ({
  ...
  const wrapperClass = `fixed top-1/2 -translate-y-1/2 z-50 hidden md:block ${isRight ? 'right-0' : 'left-0'}`;
...
const SpeedDialSectionContent = ({
  ...
  const floating = (
    <>
      ...
      {style === 'dock' && renderDock({ actions, isRight, tokens, context, groupLabel, isOpen, onToggle, showBackToTop, onBackToTop, enableShadow })}
